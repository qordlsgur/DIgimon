...
public:
	...
	HRESULT Perspective_Render(_matrix View, _matrix Proj, const _wstring& strFontTag, const _tchar* pText, const _float2& vPosition, _fvector vColor, _float vScale);
