...
PS_OUT_EFFECT PS_MAIN_EFFECT(PS_IN_EFFECT In)
{
    ...
    vMtrlDiffuse.a = vMtrlDiffuse.a * Mask.a;
...
VS_OUT_DOWN VS_DOWN(VS_IN_DOWN In)
{
    VS_OUT_DOWN Out;
...
PS_OUT_DOWN PS_DOWN(PS_IN_DOWN In)
{
    PS_OUT_DOWN Out;
...
VS_OUT_ATTACK VS_ATTACK(VS_IN_ATTACK In)
{
    VS_OUT_ATTACK Out;
...
PS_OUT_ATTACK PS_PUNCH(PS_IN_ATTACK In)
{
    PS_OUT_ATTACK Out;
...
PS_OUT_ATTACK PS_KNIFE(PS_IN_ATTACK In)
{
    PS_OUT_ATTACK Out;
...
technique11 DefaultTechnique
{
    ...
    pass Down
    {
        ...
        SetDepthStencilState(DSS_Default, 0);
        SetBlendState(BS_Blend, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
        VertexShader = compile vs_5_0 VS_DOWN();
        GeometryShader = NULL;
    ...
    pass Punch
    {
        ...
        VertexShader = compile vs_5_0 VS_DOWN();
        GeometryShader = NULL;
        PixelShader = compile ps_5_0 PS_PUNCH();
    }
    pass kNife
    {
        SetRasterizerState(RS_Cull_None);
        ...
        VertexShader = compile vs_5_0 VS_DOWN();
        GeometryShader = NULL;
        PixelShader = compile ps_5_0 PS_KNIFE();
    }
