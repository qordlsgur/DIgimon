...
class CAngewomonSkill1 final : public CSkillObject
{
private:
	CAngewomonSkill1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAngewomonSkill1(const CAngewomonSkill1& Prototype);
	virtual ~CAngewomonSkill1() = default;
