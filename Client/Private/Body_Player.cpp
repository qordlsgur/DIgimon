...
_float4x4* CBody_Player::Get_BoneMatrixPtr(const _char* pBoneName)
{
...
HRESULT CBody_Player::Initialize(void* pArg)
{
	...
	//m_pModelCom->Set_AnimationName(3);
...
void CBody_Player::Update(_float fTimeDelta)
{
	...
	//m_pModelCom->Anim_Speed(0, 50);
	//m_pModelCom->Anim_Speed(8, 50);
	//m_pModelCom->Anim_Speed(9, 50);
	//m_pModelCom->Anim_Speed(10, 35);

	//if (m_eState == DIGIMONSTATE::SKILL3)
	//	Set_Weapon(fTimeDelta);
...
void CBody_Player::Set_Animation(const _char* szName, _bool bisLoop)
{
	m_pModelCom->Set_AnimationIndex(szName, bisLoop);
}

void CBody_Player::Set_Weapon(_float fTimeDelta)
{
	//m_fTrack = m_pModelCom->Get_CurrentTrackPosition();
	//if (m_fTrack >= 18)
	//	m_bWeapon = true;
