...
HRESULT CLevel_GamePlay::Ready_Lights()
{
	...
	//PointLightDesc.eType = LIGHT::POINT; // 방향광 대신 점광원
	...
	//PointLightDesc.vPosition = _float4(0.f, 80.f, 0.f, 1.f); // 씬 중앙
	//PointLightDesc.fRange = 100.f; // 빛이 퍼지는 반경
...
HRESULT CLevel_GamePlay::Ready_Layer_Player(const _wstring& strLayerTag)
{
	...
	//if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::GAMEPLAY), TEXT("Prototype_GameObject_BlackwargreymonSkill3"),
	//	ENUM_CLASS(LEVEL::GAMEPLAY), strLayerTag)))
	//	return E_FAIL;	
...
HRESULT CLevel_GamePlay::Ready_Layer_Interaction(const _wstring& strLayerTag)
{
	...
	if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::GAMEPLAY), TEXT("Prototype_GameObject_Battle"),
		ENUM_CLASS(LEVEL::GAMEPLAY), strLayerTag)))
		return E_FAIL;
